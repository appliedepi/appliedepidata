## code to prepare `fulton_data` dataset goes here

# Define the path to the Excel file in inst/extdata
file_path <- system.file("extdata", "fulton_data.xlsx", package = "appliedepidata")

# Read in the Excel file using rio
fulton_data <- rio::import(file_path)
...
usethis::use_data(fulton_data, overwrite = TRUE)
