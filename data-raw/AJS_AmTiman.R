## code to prepare `AJS_AmTiman` dataset goes here
# This creates an .rda format of the AJS_AmTiman.xlsx file

# Define the path to the Excel file in inst/extdata
file_path <- system.file("extdata", "AJS_AmTiman.xlsx", package = "appliedepidata")

# Read in the Excel file using rio
AJS_AmTiman <- rio::import(file_path)
...
usethis::use_data(AJS_AmTiman, overwrite = TRUE)
