...
- [x] search available datasets (wrapper around list/*tableoftables* to make searchable by country, disease, language, name, ID, etc)
  - [ ] needs tests (no point me doing it as I have no idea what am doing)
