# Clean anonymized COVID-19 linelist data from Fulton County (USA), 2020
...
2021. This data has been cleaned to standardise column names and
content, format column classes, and remove erroneous data.
...
An object of class `data.frame` with 81757 rows and 40 columns.
...
data on clinical, laboratory and epidemiological information. It is the
clean version of
[fulton_data](https://appliedepi.github.io/appliedepidata/reference/fulton_data.md)
and can be used together with
[fulton_population](https://appliedepi.github.io/appliedepidata/reference/fulton_population.md)(population
data by county).
