# Military Hospital subset, fictional Ebola Virus Disease case linelist (West Africa, 2014)

Military Hospital subset of the cleaned fictional Ebola Virus Disease
case linelist, one of six per-hospital files prepared for an
...
A data frame with 896 rows and 30 columns

## Source

Within this package the original dataset is
`example_military_hospital.csv`.
