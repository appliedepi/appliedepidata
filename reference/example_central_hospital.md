# Central Hospital subset, fictional Ebola Virus Disease case linelist (West Africa, 2014)

Central Hospital subset of the cleaned fictional Ebola Virus Disease
...
A data frame with 454 rows and 30 columns

## Source

Within this package the original dataset is
`example_central_hospital.csv`.
