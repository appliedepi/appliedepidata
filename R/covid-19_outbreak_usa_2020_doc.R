...
#'  
#' @source This data was collected by Fulton County for surveillance purposes, 
...
#' cleaned to standardise column names and content, format column classes, and 
...
#' @title Zip-code population data Fulton County (USA), 2020
#'
#' @description
#' Table of population size per zip code in Fulton County (USA), 2020
#'  
#' @details
#' This is an aggregate dataset with population size per zip code in Fulton 
#' County (USA), 2020. It can be used together with \link{fulton_data} or 
#' \link{fulton_data_clean}, which are raw and clean versions of COVID-19 
#' linelist data for Fulton County respectively. 
#' 
#' Please note, that some data has been adapted in order to best achieve
#' training objectives. 
#'  
